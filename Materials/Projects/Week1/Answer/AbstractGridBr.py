...
draw_circles_grid(window, 2*WIDTH // 3, 0, WIDTH // 3, WIDTH // 3, 40, GREEN)
...
draw_circles_grid(window, 0, 2*WIDTH // 3, WIDTH // 3, WIDTH // 3, 30, CYAN)
draw_circles_grid(window, WIDTH // 3, 2*WIDTH // 3, WIDTH // 3, WIDTH // 3, 70, MAGENTA)
    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                pygame.image.save(window, "AbstractGridBr.png")
                running = False
