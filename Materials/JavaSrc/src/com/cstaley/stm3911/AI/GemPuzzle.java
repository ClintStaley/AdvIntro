...
public class GemPuzzle implements Problem {
   public static final int MAX_DIM = 10;  // Don't exceed 11
   
   // GemStep specifies a move of the open spot on the Gem puzzle board.
   ...
   private class GemState implements Problem.State {
      ...
      public int getDistance() {
         ...
         for (ndx = 0; ndx < mBoard.length; ndx++) {
            if (mBoard[ndx] != 0 && mBoard[ndx]-1 != ndx) {
               rDiff = (mBoard[ndx]-1) / mColDim - ndx / mColDim;
