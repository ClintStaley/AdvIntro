...
public class TreeSet<E> implements Set<E> {
   ...
   public boolean add(E toAdd) {
      ...
      if (child != null)
         ...
         if (parent == null)
            root = child;
         else if (cmp.compare((E)parent.data, toAdd) < 0)
            parent.right = child;
         else
            parent.left = child;
         return true;
   ...
   public boolean contains(Object toFind) {
      ...
      while (nd != null && !nd.data.equals(toFind))
         nd = cmp.compare((E)nd.data, (E)toFind) < 0 ? nd.right : nd.left;
   ...
   public boolean remove(Object toDrop) {
      ...
      while (toDelete != null && cmp.compare((E)toDrop, (E)toDelete.data) != 0) {
         parent = toDelete;
         goLeft = cmp.compare((E)toDelete.data, (E)toDrop) > 0;
   ...
   private boolean verifyRec(Node root, Comparator<E> cmp, E lo, E hi) {
      return root == null && (lo == null || hi == null || cmp.compare(lo, hi) < 0) 
       || verifyRec(root.left, cmp, lo, (E)root.data) 
       && verifyRec(root.right, cmp, (E)root.data, hi);
   }
